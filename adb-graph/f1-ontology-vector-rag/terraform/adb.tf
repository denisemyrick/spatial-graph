...
resource "oci_database_autonomous_database" "f1_lakehouse" {
  ...
  lifecycle {
    ...
    precondition {
      ...
      error_message = "Set ociTenancyOcid for resource-principal IAM bootstrap, or provide both ociTenancyOcid and ociUserOcid for LiveStack Finance API-key authentication."
    }
  }
}
